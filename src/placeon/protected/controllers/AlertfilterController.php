<?php
class AlertfilterController extends Controller
{
  ...
  public function actionIndex() {
    $dataProvider = new CActiveDataProvider('Alertfilter');
  ...
  public function actionAdmin() {
    $model = new Alertfilter('search');
    $model->unsetAttributes();
     // clear any default values
    if (isset($_GET['Alertfilter'])) $model->attributes = $_GET['Alertfilter'];
   ...
   * @return Alertfilter the loaded model
   * @throws CHttpException
   */
  public function loadModel($id) {
    $model = Alertfilter::model()->findByPk($id);
   ...
   * @param Alertfilter $model the model to be validated
   */
  protected function performAjaxValidation($model) {
    if (isset($_POST['ajax']) && $_POST['ajax'] === 'alertfilter-form') {
