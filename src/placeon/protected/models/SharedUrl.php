 ...
 * @property SharedUrlData $SharedUrlData
 * @property CrugeUser $idUser
 */
class SharedUrl extends State
{
	/**
	...
	public function relations()
	{
		...
		return array_merge(parent::relations(), array(
			'data' => array(self::HAS_ONE, 'SharedUrlData', 'id_state'),
	...
	public function search()
	{
		...
		$criteria->compare('data.url',$this->data->url,true);
