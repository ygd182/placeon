...
--
-- Servidor: localhost
-- Tiempo de generación: 21-08-2013 a las 00:48:14
...
(1, NULL, NULL, 1376941388, 'admin', 'admin@tucorreo.com', 'admin', NULL, 1, 0, 0),
...
--
ALTER TABLE `score`
  ADD CONSTRAINT `score_ibfk_1` FOREIGN KEY (`id_user`) REFERENCES `cruge_user` (`iduser`);

--
-- Filtros para la tabla `user`
--
ALTER TABLE `user`
  ADD CONSTRAINT `user_ibfk_1` FOREIGN KEY (`fk_typeId`) REFERENCES `usertype` (`id`);
