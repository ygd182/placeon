...
--
-- Servidor: localhost
-- Tiempo de generación: 28-09-2013 a las 22:37:47
...
INSERT INTO `announcement_data` (`id_state`, `message`) VALUES
(5, 'mes');
...
INSERT INTO `comment` (`id_place`, `id_user`, `comment`, `date`) VALUES
(6, 2, 'comentario1', '2013-09-11');
...
(1, NULL, NULL, 1380058633, 'admin', 'admin@tucorreo.com', 'admin', NULL, 1, 0, 0),
(2, NULL, NULL, NULL, 'invitado', 'invitado', 'invitado', NULL, 1, 0, 0),
(3, 1376845914, NULL, 1379807606, 'pepe', 'pepe@mail.com', 'pepe12', '2e0e9d031309f89fb3615618fd2b6288', 1, 0, 0),
...
(7, 1378698865, NULL, 1379807421, 'place1', 'place@m.com', 'place1', '9b655b917a892fdbb2bed16ada930f20', 1, 0, 0);
...
(7, -36.87962060502676, '0000-00-00', 4, -60.29296875),
(7, -37.3211306, '0000-00-00', 5, -59.14420310000003);
...
INSERT INTO `review` (`id_place`, `id_user`, `score`, `date`, `comment`) VALUES
(6, 2, 5, '2013-06-12', 'comment1'),
(6, 4, 8, '2013-09-09', ''),
(7, 4, 4, '2013-08-12', '');
...
INSERT INTO `state` (`id`, `id_user`, `date`, `type`, `description`) VALUES
(5, 0, '0000-00-00', 'Announcement', 'desc');
