...
<html class="ui-mobile">
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo Yii::app()->request->baseUrl; ?>/css/liveurl.css" />
    ...
    <script src="<?php echo Yii::app()->request->baseUrl; ?>/js/geolocation.js"></script>
		<script src="<?php echo Yii::app()->request->baseUrl; ?>/js/mapPosition.js"></script>
    
    <script src="<?php echo Yii::app()->request->baseUrl; ?>/js/lib/jquery.liveurl.js"></script>
    <script src="<?php echo Yii::app()->request->baseUrl; ?>/js/urlPreview.js"></script>
