...
<html class="ui-mobile">
	<head>
		<meta>a http-equiv="content-type" content="text/html; charset=UTF-8"><!-- base href="http://jquerymobile.com/demos/1.2.0-alpha.1/docs/pages/multipage-template.html" -->
		<meta charset="utf-8">
    ...
    <script src="<?php echo Yii::app()->request->baseUrl; ?>/js/geolocation.js"></script>
		<script src="<?php echo Yii::app()->request->baseUrl; ?>/js/friendsList.js"></script>
	</head>								
